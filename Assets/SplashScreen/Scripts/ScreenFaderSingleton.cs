...
public class ScreenFaderSingleton : Singleton<ScreenFaderSingleton> {
    ...
    void Awake()
    {
        ...
        else
        {
            ...
            faderPrefab = GameConfiguration.screenFaderPrefab;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Escape))
        {
            ...
            if (SceneManager.GetActiveScene().buildIndex == GameConfiguration.LevelSceneIndex)
                FadeAndGoBack();
           else if (SceneManager.GetActiveScene().buildIndex == GameConfiguration.MainMenuSceneIndex)
    ...
    private void LoadLevel()
    {
        ...
        if (SceneManager.GetActiveScene().buildIndex == GameConfiguration.SplashScreenSceneIndex)
            SceneManager.LoadScene(GameConfiguration.MainMenuSceneIndex);
       else if (SceneManager.GetActiveScene().buildIndex == GameConfiguration.MainMenuSceneIndex)
            SceneManager.LoadScene(GameConfiguration.LevelSceneIndex);
