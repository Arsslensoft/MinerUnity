...
public static class GameConfiguration
{
    ...
    public static float Score = 0;                                                      //the player score

    public static float HighestScore = PlayerPrefs.GetFloat("highestPlayerScore");        //the player highest score
    ...
    public static float highestScoreAchieved = PlayerPrefs.GetFloat("highestScore");            //Pull the HighScore from playerPrefs            
    ...
    public const int LevelSceneIndex = 2, MainMenuSceneIndex = 1, SplashScreenSceneIndex = 0;
